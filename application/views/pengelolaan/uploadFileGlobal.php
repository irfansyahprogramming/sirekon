...
<div class="page-title">
    <div class="title_left">
        <h3>Pengelolaan <small><i class="fa fa-arrows-right"></i><span class="fa fa-long-arrow-right"></span> File Global</small></h3>
    </div>
</div>
	...
	<div class="x_panel">
		...
		<div class="x_content">
		    <p class="text-muted font-13 m-b-30">
		    	<button id="btnTambah" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah File</button>
		    </p>
					...
					<form id="formFile" method="post">
						<div class="col-xs-12 col-sm-12">
							<div class="form-group">
								<label for="fileUpload" class="control-label">File Data Global Bank  </label>
								<div>
							...
							<div class="form-group">
								...
								<div>
									<select id="bank" name="bank" class="form-control select-chosen" placeholder="Pilih BANK" required>
...
<script type="text/javascript">
	...
	function save_file()
	{
		...
		url = serviceAPI+'/api/pengelolaanDB/fileGlobal';
	...
	function editFileGlobal(id)
	{
	    save_method = 'update';
	    $('#formFile')[0].reset(); // reset form on modals
	    $('.form-group').removeClass('has-error'); // clear error class
	    $('.help-block').empty(); // clear error string
	 	url = serviceAPI+'/api/pengelolaanDB/fileGlobal/'+id;
	...
	function bookFile(id)
	{
		...
		url = serviceAPI+'/api/pengelolaanDB/bookFileGlobal/'+id;
	...
	function deleteFileGlobal(id)
	{
	    if(confirm('Are you sure delete this data?'))
	    {
	        ...
	        url = serviceAPI+'/api/pengelolaanDB/delFileGlobal/'+id;
	        $.ajax({
	        	url : url,
	            type: "GET",
	            method: "GET",
