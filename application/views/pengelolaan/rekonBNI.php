...
<div class="viewer">
	<div class="container">
		...
		<form id="form-filter" class="form-horizontal">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-3">Tanggal Pembayaran</label>
				<div class="input-group col-md-9 col-sm-9 col-xs-9">
	                <input type='text' class="form-control date" id="tglBayar" name="tglBayar" required/>
	            </div>
			</div>
...
$(document).ready(function(){
	...
	$('#form-filter').submit(function(event) {
		...
		var x = tglBayar.split('/');
		var tgl_pembayaran = x[2]+'-'+x[0]+'-'+x[1];
		
		url = serviceAPI+'/api/pengelolaanDB/prosesRekonTIKBNI/'+bank+'/'+tgl_pembayaran;
